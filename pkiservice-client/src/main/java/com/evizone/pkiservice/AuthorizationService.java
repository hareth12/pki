...
@WebServiceClient(name = "AuthorizationService", 
                  wsdlLocation = "${authorizationServiceUrl}",
...
public class AuthorizationService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("${authorizationServiceUrl}");//http://127.0.0.1:8080/pkiservice/AuthorizationService?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from ${authorizationServiceUrl}");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
